...
export const CONTENT = {
  ...
  /* ── § 2 简介 ──────────────────────────────────────────────────────── */
  description:
    '相声是一门以「说学逗唱」见长的语言艺术——两三人往台上一站，从生活里最平凡的小事说起，' +
    '靠一逗一捧、一个包袱抖开，就能把满座观众逗得前仰后合。它考验的不只是记性和口才，' +
    '更是对生活的观察力，以及搭档之间那份心照不宣的默契。\n' +
    '在马大华文学会，相声组是把这门传统曲艺搬上校园舞台的一群人。从每年迎新夜的第一次登台，' +
    '到例常班里一遍遍抠台词、对节奏，再到大型相声观摩会上正式验收成果——相声组的舞台，' +
    '就是一群人从「敢开口」慢慢练成「会逗笑」的过程。\n' +
    '说相声从来不只是逗人一笑，更是把日常琐事说出滋味、把观察力练成表达力的过程——' +
    '而这，也是相声组想留给每一位加入者最好的礼物。',
